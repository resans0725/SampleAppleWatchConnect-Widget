...
struct CountWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = CountWidgetAttributes(name: "Me")
    static let contentState = CountWidgetAttributes.ContentState(value: 3)
